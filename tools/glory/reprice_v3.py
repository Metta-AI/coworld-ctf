...
# ---- CATALOG v3 proposed re-pricing, ITERATION 2 (more aggressive) ----
NEW_BASE_CLASS = {
    "dFinal8": 1.0, "dFinal4": 1.0, "dFinal2": 1.3,
    "dClosingTime": 1.1, "dClosingTime_winbumped": 1.2, "dJointAct": 2,
    "dHonorableKill": 2.2, "dShieldSoak": 1.6, "dClutchHeal": 1.8,
    "dPointBlankKill": 2.5, "dLevelUp": 1.0,
    # Boost the ALREADY-real kill classes too -- the design law says
    # magnitude moves to "kills" broadly, not only the ex-commons.
    "dFirstBlood": 4, "dLongshotKill": 6, "dSplashMultiKill": 6,
    "dRevengeKill": 4, "dRunDown": 4, "dAceTag": 9, "dLastLight": 8,
}
TERRITORY_SCALE = 0.15
HEAT_REMAP = {1: 1, 2: 5, 4: 14, 8: 36}
STACK_SCALE = 2.5
CLEAN_SHEET_NEW_AMT = 1.05                  # treeSquad tier IV (0-idx hp=3)
SHARPSHOOTER_SCALE = 0.5                    # treeGun tier V (hp=4): shrink toward a smaller, still-real bump
