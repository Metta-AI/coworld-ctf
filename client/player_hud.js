...
(function () {
  ...
  let lastGoodAlive = null, lastGoodChipsHtml = '';
  function teamAliveChips(state) {
    ...
    if (aliveCount === 0) {
      ...
      // next to a dash.
      if (lastGoodAlive !== null) return { html: lastGoodChipsHtml, aliveCount: lastGoodAlive, held: true };
      return { html: '', aliveCount: null };
    }
    lastGoodAlive = aliveCount; lastGoodChipsHtml = html;
