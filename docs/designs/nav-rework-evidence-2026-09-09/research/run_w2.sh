...
run_dir="$HOME/nav-throughput-results-20260909/W2"
...
cp "$HOME/w2-input/body_hazard.nim" src/shell/body_hazard.nim
cp "$HOME/w2-input/body_route_index.nim" src/shell/body_route_index.nim
cp "$HOME/w2-input/body_safety_query.nim" src/shell/body_safety_query.nim
cp "$HOME/w2-input/body_nav.nim" src/shell/body_nav.nim
cp "$HOME/w2-input/body_route_query.nim" src/shell/body_route_query.nim
cp "$HOME/w2-input/bench_body_nav_rework.nim" tools/bench_body_nav_rework.nim
cp "$HOME/w2-input/build_nav_route_corpus.nim" tools/build_nav_route_corpus.nim
for arm in parent candidate; do
 cp "$HOME/w2-input/body_map-$arm.nim" src/shell/body_map.nim
...
set +e
taskset -c 5 "$run_dir/bench-candidate" --quality --activation > "$run_dir/quality-activation.json" 2> "$run_dir/quality-activation.stderr"
