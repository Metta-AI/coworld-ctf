...
run_dir="$HOME/nav-throughput-results-20260909/D1"
test ! -e "$run_dir"
...
cp "$HOME/d1-input/body_hazard.nim" src/shell/body_hazard.nim
cp "$HOME/d1-input/body_route_index.nim" src/shell/body_route_index.nim
cp "$HOME/d1-input/body_safety_query.nim" src/shell/body_safety_query.nim
cp "$HOME/d1-input/body_map.nim" src/shell/body_map.nim
cp "$HOME/d1-input/body_route_query.nim" src/shell/body_route_query.nim
cp "$HOME/d1-input/bench_body_nav_rework.nim" tools/bench_body_nav_rework.nim
cp "$HOME/d1-input/build_nav_route_corpus.nim" tools/build_nav_route_corpus.nim
sha256sum "$HOME/d1-input/"*.nim > "$run_dir/input-source-hashes.txt"
lscpu > "$run_dir/lscpu.txt"
for arm in parent candidate; do
 cp "$HOME/d1-input/body_nav-$arm.nim" src/shell/body_nav.nim
