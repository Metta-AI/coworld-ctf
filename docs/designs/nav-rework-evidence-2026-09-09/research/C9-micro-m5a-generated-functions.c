N_LIB_PRIVATE N_NIMCALL(void, convertAndReplay__bench95danger95lazy95list_u4678)(tyObject_BodyNavSeatcolonObjectType___TCU9agD24ECKSDjww9bGqU3w* seat_p0, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ origin_p1, NI base_p2, tyObject_ListStore__PWDLgdApxaDy0xYm8huduA* store_p3, NI listIndex_p4) {
	NI radius_1;
	NI diameter_1;
			...
			while (1) {
				...
				word_1 = (*(*seat_p0).dangerSourceCache).bits.p->data[(NI)(TM__W7aMY615OVJySGXx9cwCHLQ_224)];
				{
					while (1) {
						...
						T6_ = (NI)0;
						T6_ = countTrailingZeroBits__OOZOOZOnimbyZpkgsZzippyZsrcZzippyZinternal_u471(word_1);
						...
						pluseq___OOZOOZOnimbyZpkgsZbumpyZsrcZbumpy_u130((&(*seat_p0).danger.values.p->data[gridIndex_1]), weight_1);
						{
							NI32 colontmpD_;
							NI TM__W7aMY615OVJySGXx9cwCHLQ_236;
							tyObject_ListEntry__tPido4VE2x7gbvIORGOLFA T11_;
...
N_LIB_PRIVATE N_NIMCALL(void, replayList__bench95danger95lazy95list_u4732)(tyObject_BodyNavSeatcolonObjectType___TCU9agD24ECKSDjww9bGqU3w* seat_p0, tyObject_ListStore__PWDLgdApxaDy0xYm8huduA* store_p1, NI listIndex_p2) {
	NI base_1;
...
{	if (nimMulInt(listIndex_p2, (*store_p1).capacity, &TM__W7aMY615OVJySGXx9cwCHLQ_240)) { raiseOverflow(); goto BeforeRet_;
	...
	base_1 = (NI)(TM__W7aMY615OVJySGXx9cwCHLQ_240);
	{
		...
		{
			while (1) {
				tyObject_ListEntry__tPido4VE2x7gbvIORGOLFA entry_1;
				...
				pluseq___OOZOOZOnimbyZpkgsZbumpyZsrcZbumpy_u130((&(*seat_p0).danger.values.p->data[entry_1.gridIndex]), entry_1.weight);
