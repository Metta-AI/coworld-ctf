...
run_dir="$HOME/nav-throughput-results-20260909/W1"
...
for file in src/shell/body_map.nim src/shell/body_nav.nim src/shell/body_route_query.nim tools/bench_body_nav_rework.nim tools/build_nav_route_corpus.nim; do
...
cp "$HOME/w1-input/body_nav.nim" src/shell/body_nav.nim
cp "$HOME/w1-input/body_route_query.nim" src/shell/body_route_query.nim
cp "$HOME/w1-input/bench_body_nav_rework.nim" tools/bench_body_nav_rework.nim
cp "$HOME/w1-input/build_nav_route_corpus.nim" tools/build_nav_route_corpus.nim
for arm in parent candidate; do
 cp "$HOME/w1-input/body_map-$arm.nim" src/shell/body_map.nim
