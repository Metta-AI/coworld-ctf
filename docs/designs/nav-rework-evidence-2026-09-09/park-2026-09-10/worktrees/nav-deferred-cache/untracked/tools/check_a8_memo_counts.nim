...
var memoHits, pixelDequeues: int
...
let map = newBodyMap(mapFromSpecJson($pool[48]["spec"]))
let index = newBodyRouteIndex(map)
echo %*{"memo_hits": memoHits, "pixel_dequeues": pixelDequeues,
