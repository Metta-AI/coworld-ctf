...
def main():
    ...
    # The head segment takes ALL remaining solid pixels the others didn't (the
    # central pistons + body shell), so nothing is lost and the head — drawn last
    # — covers the hub/leg-joins (no head-hole).
