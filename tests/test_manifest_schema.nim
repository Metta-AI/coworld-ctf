...
const SampleJson = """{
  ...
  "barrelRederiveJitter": {"barrelRederiveJitter": true},
  "plantAimBarrelOnly": {"plantAimBarrelOnly": true},
  "plantAimSigmaPermille": {"plantAimSigmaPermille": 700},
  "plantSettleTicks": {"plantSettleTicks": 24},
