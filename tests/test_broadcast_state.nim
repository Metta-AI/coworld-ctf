...
suite "broadcast state channel":
  ...
  test "final frame state names the verdict honestly":
    ...
    try:
      ...
      # is pinned to the current recording of the fixture (GameVersion 60,
  ...
  test "glory series ships team-keyed change points":
    ...
    try:
      ...
      # on Red capturing the blue heart, which eliminates Blue -- so Blue has
      # a real tick and Red, still standing, has -1.
      #
