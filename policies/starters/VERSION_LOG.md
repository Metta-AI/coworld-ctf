...
| aggressive scatters until the first shrink (`spawn_phase_ticks` 340, new Persona knob; others stay at 150) | v16 | v19 | v13 | XP `xreq_fd33acb3` (20 eps, 0.7.298, ROTATED roster): aggressive **1.35 kills / 20% surv / 1568 survT / 1.75 Glory — 1st of 8**, ahead of every field champion (richard 0.97, cautious 0.78). Two things changed at once (scatter window and roster order), so a replicate and a v18-on-rotated-roster counterfactual follow. |
