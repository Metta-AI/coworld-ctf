...
| aggressive base play `jackal` → tight `edge_ride` (jackal stays as the gated rung above it while an enemy is tracked) | v16 | v16 | v13 | XP 20 eps vs the same 5 field duos (pending) |
