...
def main():
    ...
    args = ap.parse_args()
    arms = [
        (CAND, False, "v27v25-AB v27 pickedge seat=Red  vs field"),
        (CAND, True,  "v27v25-AB v27 pickedge seat=Blue vs field"),
        (BASE, False, "v27v25-AB v25 base seat=Red  vs field"),
        (BASE, True,  "v27v25-AB v25 base seat=Blue vs field"),
    ]
    if args.dry:
