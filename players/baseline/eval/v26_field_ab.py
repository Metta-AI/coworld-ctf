...
def main():
    ...
    args = ap.parse_args()
    arms = [
        (CAND, False, "v26v25-AB v26 planlayer seat=Red  vs field"),
        (CAND, True,  "v26v25-AB v26 planlayer seat=Blue vs field"),
        (BASE, False, "v26v25-AB v25 base seat=Red  vs field"),
        (BASE, True,  "v26v25-AB v25 base seat=Blue vs field"),
    ]
    if args.dry:
